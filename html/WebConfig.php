<html>
 ...
 <form action="WebConfigPost.php" method="post">
   ...
   <p> <label for="Oxygen" >Oxygen: </label><input type="checkbox" name="Oxygen" id="Oxygen">  </p>
   ...
   <p> <label for="Interval" >Update interval [sec]: </label><input type="number" name="Interval" id="Interval" min="0" max="100000" step="1" value="3"> <br /> <br /></p>

   <p> <label for="PiCam" >Pi Camera: </label><input type="checkbox" name="PiCam" id="PiCam"> </p>
